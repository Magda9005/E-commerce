  ...
  cartLinesRemove?: {
    ...
    cart?: {
      ...
      lines: {
        ...
        edges: Array<{
          __typename?: "CartLineEdge";
          node: { __typename?: "CartLine"; id: string };
        }>;
      };
    } | null;
    userErrors: Array<{
...
export type GetProductsPathsQuery = {
  __typename?: "QueryRoot";
  products: {
    __typename?: "ProductConnection";
    pageInfo: {
...
export type GetFirst3ProductsQuery = {
  __typename?: "QueryRoot";
  products: {
    __typename?: "ProductConnection";
    pageInfo: {
...
export type GetNextProductsQuery = {
  __typename?: "QueryRoot";
  products: {
    __typename?: "ProductConnection";
    pageInfo: {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "selectedQuantity" },
          },
          type: {
            kind: "NonNullType",
                        ...
                        values: [
                          {
                            ...
                            fields: [
                              ...
                              {
                                kind: "ObjectField",
                                name: { kind: "Name", value: "merchandiseId" },
                                value: {
                                  kind: "Variable",
                                  name: {
                                    kind: "Name",
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: "NamedType",
                  name: { kind: "Name", value: "CheckoutLineItemInput" },
                },
              },
            },
          },
...
>;
export const GetSingleProductDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetSingleProduct" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const GetProductsPathsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetProductsPaths" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  GetProductsPathsQueryVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetProductsByCollection" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
export const GetFirst3ProductsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetFirst3Products" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
>;
export const GetNextProductsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetNextProducts" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "cursorRef" },
          },
          type: {
            kind: "NonNullType",
            type: {
  ...
  GetNextProductsQuery,
  GetNextProductsQueryVariables
>;
