...
const createCartMutation = `mutation createCart($selectedVariantId:ID!,$selectedQuantity:Int!) {
    cartCreate(
      input: {
        lines: [
          {
...
const addProductToCartMutation = `mutation AddProductToCart($cartId:ID!, $selectedQuantity:Int!,$selectedVariantId:ID!){
...
const SingleProductPage = ({ productData }) => {
    ...
    const handleAddProductToCart = () => {
        ...
        if (!cartId) {
            createCart({ selectedVariantId, selectedQuantity })
                .then(result => Cookies.set('cartId', result.data.cartCreate.cart.id)
                )
        }
